...
(function(global) {
    System.config({
        ...
        map: {
            ...
            'nf.RegistryBucketUserOrGroupPermissionsViewer': 'nifi-registry/src/js/nf-registry-bucket-user-or-group-permissions-viewer.js',
            'nf.RegistryBucketUserPermissionsViewer': 'nifi-registry/src/js/nf-registry-bucket-user-permissions-viewer.js',
            'nf.RegistryBucketGroupPermissionsViewer': 'nifi-registry/src/js/nf-registry-bucket-group-permissions-viewer.js',
